...
namespace ExamenesApp_backend.Migrations
{
    /// <inheritdoc />
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    HorarioPreferencia = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    VariosExamenes = table.Column<bool>(type: "bit", nullable: true),
                    Cuales = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FechaLimiteCancelacion = table.Column<DateTime>(type: "datetime2", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Inscripciones_Examens_ExamenId",
                        column: x => x.ExamenId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Inscripciones_ExamenId",
                table: "Inscripciones",
                column: "ExamenId");

            migrationBuilder.CreateIndex(
                name: "IX_Inscripciones_UsuarioId_ExamenId",
                table: "Inscripciones",
